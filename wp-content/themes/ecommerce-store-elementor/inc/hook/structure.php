...
if ( ! function_exists( 'ecommerce_store_elementor_footer_end' ) ) :
	...
	function ecommerce_store_elementor_footer_end() {
		...
		$ecommerce_store_elementor_enable_cursor_dot_outline = ecommerce_store_elementor_get_option('ecommerce_store_elementor_enable_cursor_dot_outline');
		if ($ecommerce_store_elementor_enable_cursor_dot_outline) { ?>
			<!-- Custom cursor -->
