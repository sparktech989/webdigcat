...
class Loraic_Admin_Plugins extends Loraic_Admin_Page {
	protected $id = null;
	...
	public function __construct() {
		...
		$this->page_title = esc_html__( 'Install Plugins', 'loraic' );
		$this->menu_title = esc_html__( 'Install Plugins', 'loraic' );
		$this->parent = 'pxlart';
	...
	public function tgmpa_plugin_action( $plugin, $status ) {
		...
		switch( $status ) {
			case 'not-installed':
			$btn_class = 'white';
			$btn_text = esc_html_x( 'Install', 'Plugin installation page.', 'loraic' );
			...
			case 'installed':
			$btn_class = 'success';
			$btn_text = esc_html_x( 'Activate', 'Plugin installation page.', 'loraic' );
			...
			case 'active':
			$btn_class = 'danger';
			$btn_text = esc_html_x( 'Deactivate', 'Plugin installation page.', 'loraic' );
		...
		$btn_text_active = esc_html_x( 'Deactivate', 'Plugin installation page.', 'loraic' );
