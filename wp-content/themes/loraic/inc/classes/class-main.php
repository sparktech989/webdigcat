...
if (!class_exists('Loraic_Main')) { 
    class Loraic_Main extends Loraic_Base
    {
...
function loraic() {
    return Loraic_Main::getInstance();
}
// Install
loraic(); 
