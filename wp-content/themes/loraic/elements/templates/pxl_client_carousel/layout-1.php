...
if(isset($settings['client']) && !empty($settings['client']) && count($settings['client'])): ?>
    <div class="pxl-swiper-sliders pxl-client-carousel pxl-client-carousel1 pxl-swiper-arrow-show <?php echo esc_attr($settings['style']); ?>" data-arrow="<?php echo esc_attr($arrows); ?>">
                        ...
                        <div class="pxl-swiper-slide">
                            <div class="pxl-item--inner <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
                               <?php if(!empty($logo['id'])) { 
                                ...
                                <div class="pxl-item-client elementor-repeater-item-<?php echo esc_attr($value['_id']); ?> ">
