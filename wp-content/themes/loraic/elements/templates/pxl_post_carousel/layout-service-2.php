...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-post-carousel pxl-service-carousel pxl-service-carousel2 pxl-service-style2 <?php echo esc_attr($settings['style']); ?>" <?php if($drap !== 'false'): ?>data-cursor-drap="<?php echo esc_html('DRAG', 'loraic'); ?>"<?php endif; ?>>
