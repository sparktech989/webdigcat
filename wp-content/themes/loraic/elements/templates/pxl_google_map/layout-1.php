...
if($scrollwheel == "true"){ $controls->scrollwheel = true; } else { $controls->scrollwheel = false; }
...
<div class="pxl-google-map">
    <div class="pxl-map-render" <?php echo implode(' ', $setting); ?> style="width:<?php echo esc_attr($width); ?>;height: <?php echo esc_attr($height).'px'; ?>"></div>
</div>
