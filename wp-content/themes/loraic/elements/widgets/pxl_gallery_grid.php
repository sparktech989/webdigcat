...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Gallery Grid', 'loraic'),
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'img_size',
                            'label' => esc_html__('Image Size Default', 'loraic' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'description' => 'Enter image size (Example: "thumbnail", "medium", "large", "full" or other sizes defined by theme). Alternatively enter size in pixels (Example: 200x100 (Width x Height).',
                        ),
                        array(
                            'name' => 'img_size_popup',
                            'label' => esc_html__('Image Size Popup', 'loraic' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'description' => 'Enter image size (Example: "thumbnail", "medium", "large", "full" or other sizes defined by theme). Alternatively enter size in pixels (Example: 200x100 (Width x Height).',
                        ),
                    ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'spacing',
                            'label' => esc_html__('Spacing', 'loraic' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'nogap',
                            'options' => [
                                'nogap' => 'No Gap',
