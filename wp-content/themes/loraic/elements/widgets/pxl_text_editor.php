...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Text Editor', 'loraic'),
        'icon' => 'eicon-text',
        ...
        'params' => array(
            'sections' => array(
                array(
                    ...
                    'label' => esc_html__('Text Editor', 'loraic' ),
                    ...
                    'controls' => array(
                        array(
                            ...
                            'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'loraic' ),
                ...
                array(
                    ...
                    'label' => esc_html__('Highlight', 'loraic' ),
