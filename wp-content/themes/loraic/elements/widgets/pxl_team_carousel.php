...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('BR Team Carousel', 'loraic'),
            ...
            'sections' => array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'social',
                                    'label' => esc_html__( 'Social', 'loraic' ),
                                    'type' => 'pxl_icons',
                                ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'color_p_hv',
                            'label' => esc_html__('Color El Hover', 'loraic' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}  .pxl-team .pxl-item--inner:hover .plus' => 'background-color: {{VALUE}} !important;',
                                '{{WRAPPER}}  .pxl-team .pxl-item--inner:hover .pxl-item--title a' => 'color: {{VALUE}} !important;',
                                '{{WRAPPER}}  .pxl-team .pxl-item--inner:hover .pxl-item--position' => 'color: {{VALUE}} !important;',
                                '{{WRAPPER}}  .pxl-team .pxl-item--inner:hover .pxl-item--social a' => 'background-color: {{VALUE}} !important;',
                            ],
                            'condition' => [
                                'layout' => '2'
                            ]
                        ...
                        array(
                            'name' => 'color_ic',
                            'label' => esc_html__('Color Icon Social', 'loraic' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}  .pxl-team i' => 'color: {{VALUE}} !important;',
                            ],
                        ),
                        array(
                            'name' => 'title_color',
                        ...
                        array(
                            'name' => 'position_color',
                            'label' => esc_html__('Position Color', 'loraic' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Position Typography', 'loraic' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
